...
int _tmain (int argc, LPTSTR argv[])
{
	...
	if (producerThreadArray == NULL || producerArg == NULL || consumerThreadArray == NULL || consumerArg == NULL)
	...
	for (iThread = 0; iThread < nThread; iThread++) {
		...
		consumerThreadArray[iThread] = (HANDLE)_beginthreadex (NULL, 0, Consumer, &consumerArg[iThread], 0, NULL);
		...
		producerThreadArray[iThread] = (HANDLE)_beginthreadex (NULL, 0,Producer, &producerArg[iThread], 0, NULL);
